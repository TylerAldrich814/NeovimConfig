...
vim.keymap.set("n", "<leader>GC", "<cmd>lua require('goto-preview').close_all_win() <CR>")
vim.keymap.set("n", "<leader>GT", "<cmd>lua require('goto-preview').goto_preview_type_definition() <CR>")
vim.keymap.set("n", "<leader>GP", "<cmd>lua require('goto-preview').goto_preview_implementation() <CR>")
